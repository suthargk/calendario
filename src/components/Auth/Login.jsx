  ...
  return (
    <div className="flex justify-center items-center flex-col h-full w-full ">
      <div className="flex items-center gap-2 text-gray-600 -ml-8">
        ...
        <h1 className="text-xl font-medium text-gray-700">Calendario</h1>
      </div>
      <p className="font-light text-sm text-gray-600 text-center p-2">
      ...
      <div className="mt-4">
        <button
          ...
          className="flex items-center gap-2 border border-gray-200 px-4 py-1.5 rounded-lg duration-300 hover:bg-gray-100"
        >
